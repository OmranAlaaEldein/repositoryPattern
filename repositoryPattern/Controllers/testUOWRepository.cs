...
namespace repositoryPattern.Controllers
{
    ...
    [ApiController]
    public class testUOWRepository : ControllerBase
    {
        //E
        ...
        public testUOWRepository(IUnitOfWork unitOfWor,ISchoolRepository schoolRepository, IStudentRepository studentRepository)
        {
